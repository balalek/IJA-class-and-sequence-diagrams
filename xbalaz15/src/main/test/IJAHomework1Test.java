...
import com.uml.Element;
import com.uml.UMLClass;
import com.uml.UMLAttribute;
import com.uml.UMLOperation;
import com.uml.Diagram;
import com.uml.Relation;
import com.uml.MessageArrow;
...
public class IJAHomework1Test {
    ...
    /**
     * Test, zda funguje odstranění třídy
     */
    @Test
    public void testRemoveClass(){
        ...
        UMLClass cls3 = d.createClass("C3"); 

        Assert.assertEquals("Klasifikator s nazvem C1 je v diagramu", cls, d.findClassifier("C1"));
        Assert.assertEquals("Klasifikator s nazvem C2 je v diagramu", cls2, d.findClassifier("C2"));
        Assert.assertEquals("Klasifikator s nazvem C3 je v diagramu", cls3, d.findClassifier("C3"));

        cls2 = d.removeClass("C2", cls2);

        Assert.assertNull("Klasifikator s nazvem C2 neni v diagramu", d.findClassifier("C2"));
        Assert.assertNull("Klasifikator s nazvem C2 neni v diagramu", cls2);
    }
